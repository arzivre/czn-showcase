...
export function DefaultCatchBoundary({ error }: ErrorComponentProps) {
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center p-4 py-24 sm:py-32">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            {isRoot ? (
              <Button variant="outline" asChild>
                <Link to="/" search={{ page: 1, pageSize: 25 }} className="flex items-center gap-2">
          ...
          <div className="border-t pt-4">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
              ...
              <a href="https://discord.gg/9hyCZZAk" target="_blank" rel="noopener noreferrer">
                <Button
                  variant="outline"
                  size="sm"
